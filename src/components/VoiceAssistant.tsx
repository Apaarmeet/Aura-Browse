...
const VoiceAssistant: React.FC = () => {
  ...
  const getMicButtonClasses = (): string => {
    const baseClasses = "w-16 h-16 rounded-full border-none text-white cursor-pointer flex items-center justify-center transition-all duration-300 shadow-lg hover:scale-105"
  ...
  return (
    <div className="w-80 min-h-96 p-5 bg-white rounded-lg shadow-lg">
      ...
      <div className="mt-5 text-xs text-gray-600">
        <p className="my-2">Click the microphone and speak your command. I'll stop listening after 5 seconds of silence.</p>
        ...
        <ul className="my-2 pl-5 space-y-1">
          ...
          <li className="text-gray-500">"Navigate to Google and search for weather"</li>
